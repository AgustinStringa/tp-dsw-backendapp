...
const membershipTypesList = [
  new MembershipType("Only GYM", "Membresia que incluye solo gym", 1000),
  new MembershipType("Only Clases", "Membresia que incluye solo clases", 500),
  new MembershipType("Unified Couta", "Incluye Todo", 1500),
  new MembershipType("Only Pool", "Membresia que incluye solo pileta", 500),
  new MembershipType(
    "GYM and Pool",
  ...
  new MembershipType("Null", "No posee ninguna membresia (pobre)", 0),
];
