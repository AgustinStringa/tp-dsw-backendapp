...
registrationRouter.put("/:id", controller.sanitizeRegistration, controller.update);
registrationRouter.patch("/:id", controller.sanitizeRegistration, controller.update);
